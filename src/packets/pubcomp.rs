...
use super::{reason_codes::{PubCompReasonCode, self}, mqtt_traits::{MqttRead, MqttWrite, WireLength, VariableHeaderRead, VariableHeaderWrite}, read_variable_integer, error::DeserializeError, PropertyType, PacketType, variable_integer_len, write_variable_integer};
...
mod tests{
    ...
    use crate::packets::{pubcomp::{PubComp, PubCompProperties}, mqtt_traits::{VariableHeaderRead, MqttWrite, VariableHeaderWrite, MqttRead}, reason_codes::PubCompReasonCode, PropertyType, write_variable_integer};
